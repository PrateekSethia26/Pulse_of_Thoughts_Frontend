...
function TopSection() {
  ...
  console.log(blogs);
  return (
    <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-6 pt-20">
      {blogs && blogs.length > 0 ? (
        blogs.slice(0, 4).map((element) => {
          ...
          return (
            ...
            >
              {/* As want to show the text in image so make div relative and the text absolute */}
